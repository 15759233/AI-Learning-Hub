...
const imageLoaded = (event: Event) => { const image = event.target as HTMLImageElement; image.classList.toggle('long-image', image.naturalHeight > image.naturalWidth * 1.6) }
