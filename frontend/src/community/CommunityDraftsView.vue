...
const summary = (row: CommunityDraftDto) => row.input.title || row.input.contentBlocks.map((b) => b.type === 'paragraph' ? b.text : b.type === 'heading' ? b.text : b.type === 'list' ? b.items.join(' ') : b.type === 'code' ? b.code : b.type === 'quote' ? b.text : b.alt).join(' ').slice(0, 100) || '尚未填写正文'
onMounted(load)
</script>
