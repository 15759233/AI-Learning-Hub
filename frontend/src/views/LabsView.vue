...
<template>
  <div class="page-container">
    ...
    <section v-if="featured" class="featured-lab">
      <img v-if="featured.cover || dataMode === 'mock'" :src="featured.cover || assets.labCover" :alt="`${featured.title}实训封面`" />
